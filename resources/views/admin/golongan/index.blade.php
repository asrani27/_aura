        ...
        <table class="table table-hover" id="example1">
          <thead>
            <tr style="background-color:#FFD700">
              ...
              <th style="border: 1px solid black">Nama Golongan</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="border: 1px solid black">{{$item->nama_golongan}}</td>
              <td style="border: 1px solid black;display:flex">
                <a href="/admin/data/golongan/edit/{{$item->id}}" class="btn btn-flat btn-sm btn-primary"><i
