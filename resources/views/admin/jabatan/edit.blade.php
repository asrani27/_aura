...
<div class="row">
    <div class="col-md-12">
        <a href="/admin/data/jabatan" class="btn btn-flat btn-warning"><i class="fa fa-backward"></i> Kembali</a> <br /> <br />
    </div>
</div>
...
<div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <form class="form-horizontal" method="post" action="/admin/data/jabatan/edit/{{$data->id}}">
                @csrf
