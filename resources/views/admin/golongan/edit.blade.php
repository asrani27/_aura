...
<div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <form class="form-horizontal" method="post" action="/admin/data/golongan/edit/{{$data->id}}">
                @csrf
                    <div class="form-group">
                        <label class="col-sm-2 control-label">golongan</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="nama_golongan"  value="{{$data->nama_golongan}}">
                        </div>
                    </div>
<!-- /.box-body -->
